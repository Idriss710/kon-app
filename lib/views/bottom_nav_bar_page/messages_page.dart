...
import 'package:kon/widgets/custom_widgets/custom_message_card.dart';
...
class MessagesPage extends StatefulWidget {
  ...
  const MessagesPage({Key? key, required this.onScroll, this.controller})
      : super(key: key);
...
class _MessagesPageState extends State<MessagesPage> {
  ...
  List<CustomMessageCard> _items =
      List.generate(10, (index) => CustomMessageCard());
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  onPressed: () {
                    CustomDialog(context,'Create Group',false,false,false,false,true);
                  },
...
//   bool _showTopBar = true; // للتحكم في إظهار شريط البحث
//   List<CustomMessageCard> _items =
//       List.generate(5, (index) => CustomMessageCard());
//   bool _isLoading = false;
//   final TextEditingController searchTextEditingController =
//       TextEditingController();
//   bool _isSidebarOpen = false;
