...
import 'package:kon/views/bottom_nav_bar_page/services_page.dart';
...
import 'package:kon/widgets/custom_widgets/custom_group_card.dart';
...
import 'package:kon/widgets/custom_widgets/custom_service_card_category.dart';

class ServicesPageCategories extends StatefulWidget {
  final Function(bool) onScroll;
  final NotchBottomBarController? controller;

  const ServicesPageCategories({Key? key, required this.onScroll, this.controller})
      : super(key: key);

  @override
  _ServicesPageCategoriesState createState() => _ServicesPageCategoriesState();
}

class _ServicesPageCategoriesState extends State<ServicesPageCategories> {
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            // return CustomServiceCardCategory();
            return  CustomCard(
        ...
        //       const SizedBox(width: 15),
              ...
              //   child: IconButton(
              //     onPressed: () {
              //       CustomDialog(context, 'Choose an action', false, true, false,
              //           false, false);
              //     },
