...
class GroupsPage extends StatefulWidget {
  ...
  const GroupsPage({Key? key, required this.onScroll, this.controller})
      : super(key: key);
...
class _GroupsPageState extends State<GroupsPage> {
  ...
  List<CustomGroupCard> _items =
      List.generate(5, (index) => CustomGroupCard());
